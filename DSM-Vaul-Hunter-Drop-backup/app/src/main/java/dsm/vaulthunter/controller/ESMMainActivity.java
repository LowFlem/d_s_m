...
import dsm.vaulthunter.model.ESMClient;
import teste.lucasvegi.pokemongooffline.R;

/**
 * Main activity for the ESM-integrated Vault Hunter game
 */
public class ESMMainActivity extends AppCompatActivity {
    private static final String TAG = "ESMMainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ESMClient.getInstance().connect("bootstrap.esm.network:4001");
    ...
    private void updateEventInfo() {
        ...
        ESMClient.RegionEvent currentEvent = ESMClient.getInstance().getCurrentActiveEvent();
